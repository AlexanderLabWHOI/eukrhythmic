...
rule salmon_CAG:
    ...
    output:
        os.path.join(OUTPUTDIR, "04-compare", "09-CAG-mapping",\
                     "salmon", "{assembly}_index", "quant.sf")
    params:
        libtype = "A",
        indexname = os.path.join(OUTPUTDIR, "04-compare", "09-CAG-mapping",\
                     "salmon", "{assembly}_index"),
        outdir = os.path.join(OUTPUTDIR, "04-compare", "09-CAG-mapping",\
